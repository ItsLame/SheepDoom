...
namespace SheepDoom
{
    public abstract class Objective : NetworkBehaviour
    {
        ...
        protected GameObject P_captureGameObject
        {
            get{return captureGameObject;}
            set{captureGameObject = value;}
        }
        ...
        protected bool P_capturedByBlue
        {
            get{return capturedByBlue;}
            set{capturedByRed = value;}
        }

        protected bool P_capturedByRed
        {
